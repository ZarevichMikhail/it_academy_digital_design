...
HD_PWD='/home/IT.ACADEMY/student/plis/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_latch.tcl
