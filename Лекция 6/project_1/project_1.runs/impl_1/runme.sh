...
HD_PWD='/home/IT.ACADEMY/student/plis/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_latch.tcl -notrace
